...
def func(item1,item2,item3,item4,item5,item6):
    ...
    if int(c) > int(f): #PM | type_kill=weakly args=[2776.55, 2057.34, -9401.47, -3249.99, -5696.06, 2598.68] | type_kill=strongly args=[2776.55, 2057.34, -9401.47, -3249.99, -5696.06, 2598.68]
        r += int(f) - int(c)
