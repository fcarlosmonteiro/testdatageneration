...
def func(item1,item2,item3,item4,item5,item6):
    ...
    if not (int(b) < int(e)): #PM | type_kill=weakly args=[7060, 7351.6, 5571.16, 7060.99, -5149.83, 2523.41] | type_kill=strongly args=[7060, 7351.6, 5571.16, 7060.99, -5149.83, 2523.41]
        r += int(e) - int(b)
