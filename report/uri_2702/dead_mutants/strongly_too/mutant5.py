...
def func(item1,item2,item3,item4,item5,item6):
    ...
    if int(a) > int(d): #PM | type_kill=weakly args=[7060, 7351.6, 5571.16, 7060.99, -5149.83, 2523.41] | type_kill=strongly args=[2776.55, 2057.34, -9401.47, -3249.99, -5696.06, 2598.68]
        r += int(d) - int(a)
