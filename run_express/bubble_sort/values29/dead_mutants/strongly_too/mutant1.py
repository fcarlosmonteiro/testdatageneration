...
def bubble_sort(item1,item2,item3,item4,item5):
    ...
    for j in range(0,dist):
        for i in range(0,dist-1):
            if not (list[i] > list[i + 1]): #PM | type_kill=weakly args=[-3492.95, -7996.41, 3615.34, 6175.94, 1661.94] | type_kill=strongly args=[-3492.95, -7996.41, 3615.34, 6175.94, 1661.94]
                t=list[i]
                list[i]=list[i+1]
                list[i+1]=t
    return list
