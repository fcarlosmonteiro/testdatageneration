...
def bubble_sort(item1,item2,item3,item4,item5):
    ...
    for j in range(0,dist):
        for i in range(0,dist-1):
            if not (list[i] > list[i + 1]): #PM | type_kill=weakly args=[-1097.26, -7551.37, -4625.78, -4164.23, 6221.43] | type_kill=strongly args=[-1097.26, -7551.37, -4625.78, -4164.23, 6221.43]
                t=list[i]
                list[i]=list[i+1]
                list[i+1]=t
    return list
