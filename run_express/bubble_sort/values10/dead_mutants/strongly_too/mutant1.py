...
def bubble_sort(item1,item2,item3,item4,item5):
    ...
    for j in range(0,dist):
        for i in range(0,dist-1):
            if not (list[i] > list[i + 1]): #PM | type_kill=weakly args=[8366.36, 9046.05, -2747.36, 8400.78, -6506.34] | type_kill=strongly args=[8366.36, 9046.05, -2747.36, 8400.78, -6506.34]
                t=list[i]
                list[i]=list[i+1]
                list[i+1]=t
    return list
