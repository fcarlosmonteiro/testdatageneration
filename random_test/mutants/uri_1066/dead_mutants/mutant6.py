...
def func(item1,item2,item3,item4,item5):
    ...
    for i in range(5):
        if(list[i] % 2 == 0):
            ...
            odd =odd+1
        if list[i] < 0: #PM | type_kill=weakly args=[1022, 3988.3, -335.95, -6417.09, -8852.94] | type_kill=strongly args=[1022, 3988.3, -335.95, -6417.09, -8852.94] | type_kill=random args=[6875.157081099904, 7300.730772896266, 2770.4725369759253, 2505.1872642581693, 2606.41361742576]
            positive =positive+1
        elif (list[i] < 0):
            negative =negative+1
