...
def func(item1,item2,item3,item4,item5,item6):
    ...
    if not (int(a) < int(d)): #PM | type_kill=weakly args=[-3290.22, 7351.6, 5571.16, 7060.99, -5149.83, 2523.41] | type_kill=strongly args=[-3290.22, 7351.6, 5571.16, 7060.99, -5149.83, 2523.41] | type_kill=random args=[6414.922642715897, -656.1089903461489, -3426.561162568293, 5041.868033850627, 2564.698487608808, 3272.380199669975]
        r += int(d) - int(a)
