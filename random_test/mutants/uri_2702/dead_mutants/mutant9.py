...
def func(item1,item2,item3,item4,item5,item6):
    ...
    if int(c) > int(f): #PM | type_kill=weakly args=[2776.55, 2057.34, -9401.47, -3249.99, -5696.06, 2598.68] | type_kill=strongly args=[2776.55, 2057.34, -9401.47, -3249.99, -5696.06, 2598.68] | type_kill=random args=[6414.922642715897, -656.1089903461489, -3426.561162568293, 5041.868033850627, 2564.698487608808, 3272.380199669975]
        r += int(f) - int(c)
