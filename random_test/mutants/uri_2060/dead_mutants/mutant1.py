...
def func(item1,item2,item3,item4,item5):
    ...
    for y in x:
        y = int(y)
        if not (y % 2 == 0): #PM | type_kill=weakly args=[-7038.25, 3277.83, -8251.13, 8511.23, -3857.47] | type_kill=strongly args=[-7038.25, 3277.83, -8251.13, 8511.23, -3857.47] | type_kill=random args=[6440.83725513619, 5642.804000854938, 9747.600917129923, 9806.676003617242, -2540.7948551715554]
            m2 += 1
        if y % 3 == 0:
            m3 += 1
        if y % 4 == 0:
