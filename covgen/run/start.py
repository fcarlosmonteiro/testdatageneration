...
def print_help():
    print('Usage: python start.py <target file location>')
    print(
        '       python start.py <target file location> --function <target function name> --method <method name=avm or hillclimbing> --retry-count <retry_count> --int-min <minimum int> --int-max <maximum int>')
    print(
        '       python start.py <target file location> -f <target function name> -m <method name=avm or hillclimbing> -r <retry_count>')
